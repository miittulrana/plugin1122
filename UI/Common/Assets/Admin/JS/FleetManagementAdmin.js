...
var FleetManagementAdmin = {
    ...
    printInvoicePopup: function(paramExtCode, paramInvoiceId, paramInvoiceTitle)
    {
        'use strict';
        var validExtCode = this.getValidCode(paramExtCode, '', true, false, false);
        var urlPrefix = this.vars[validExtCode]['EXT_URL_PREFIX'];
        ...
        var url = 'admin.php?page=' + urlPrefix + 'print-invoice&noheader=true' + '&invoice_id=' + paramInvoiceId;
        var params = 'width=' + width + ', height=' + height;
            ...
            params += ', status=no';
            params += ', toolbar=no';
        var newWindow = window.open(url, paramInvoiceTitle, params);
        if (window.focus)
        {
            newWindow.focus();
        }
