            ...
            if($canEdit || current_user_can('view_'.$this->conf->getExtPrefix().'all_bookings'))
            {
                ...
                $retHTML .= '<tr>
                    ...
                    <td align="right">
                        ...
                        <a href="javascript:;" onclick="javascript:FleetManagementAdmin.printInvoicePopup(\''.esc_js($this->conf->getExtCode()).'\', \''.esc_js($overallInvoiceId).'\', \''.esc_js($invoiceTitle).'\');" class="bodytext">'.$this->lang->escHTML('LANG_INVOICE_PRINT_TEXT').'</a><br />
                        '.$links.'
                    </td>
                 </tr>';
            }
