...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'View Reservations',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'View Unpaid Reservations',
    'LANG_ORDERS_NONE_YET_TEXT' => 'No reservations yet',
    'LANG_ORDER_DETAILS_TEXT' => 'Reservation Details',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Customer Details (Latest version from database)',
    'LANG_ORDER_STATUS_TEXT' => 'Reservation Status',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Departed',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Completed Early',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Completed',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'Active',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'Cancelled',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Paid',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Unpaid',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Refunded',
    'LANG_INVOICE_PRINT_TEXT' => 'Print Invoice',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Back To Customer\'s Reservations List',
    ...
    'LANG_ORDERS_PERIOD_FROM_TO_TEXT' => 'Reservations: %s - %s',
    'LANG_PICKUPS_PERIOD_FROM_TO_TEXT' => 'Pick-ups: %s - %s',
    'LANG_RETURNS_PERIOD_FROM_TO_TEXT' => 'Returns: %s - %s',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => 'Regular Price',
    'LANG_PRICE_TYPE_TEXT' => 'Price Type',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'No calendars found for selected date range',
    'LANG_PAGE_SELECT_TEXT' => ' - Choose page - ',
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- Select Email Type ---',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'This car is not available for reservation.',
    'LANG_ITEM_PRICE_PLANS_TITLE' => 'Car Price Plans',

    // Manufacturer Element
    'LANG_MANUFACTURER_TEXT' => 'Manufacturer',
    'LANG_MANUFACTURER_ID_TEXT' => 'Manufacturer Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Manufacturer Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Manufacturer:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Manufacturer -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Add / Edit Manufacturer',

    // Class Element
    'LANG_CLASS_TEXT' => 'Class',
    'LANG_CLASS_ID_TEXT' => 'Class Id',
    'LANG_CLASS_IDS_TEXT' => 'Class Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Class:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Class -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Class',
    'LANG_CLASS_LIST_TEXT' => 'Class List',
    ...
    'LANG_PRICE_PLAN_ADD_EDIT_TEXT' => 'Add / Edit Price Plan',
    ...
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Open',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Closed',
    'LANG_LOCATION_LUNCH_TEXT' => 'Lunch',
    'LANG_LOCATION_LUNCH_TIME_TEXT' => 'Lunch Time',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Car Model',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Rental Option',
    'LANG_ITEM_MODELS_TEXT' => 'Car Models',
    'LANG_ITEMS_TEXT' => 'Cars',
    'LANG_EXTRAS_TEXT' => 'Extras',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Rental Options',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'View car model',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Search',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'with Tax',
    'LANG_TAX_WITHOUT_TEXT' => 'w/o Tax',
    'LANG_TAX_SHORT_TEXT' => 'Tax',
    'LANG_DEPOSIT_TEXT' => 'Deposit',
    'LANG_DISCOUNT_TEXT' => 'Discount',
    'LANG_PREPAYMENT_TEXT' => 'Prepayment Amount',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'No cars available',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'No cars available in this class',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'No cars available',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'No cars available in this class',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'No extras available',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Mark as Paid',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Refund Payment',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Select Location --',
    'LANG_LOCATIONS_ALL_TEXT' => 'All Locations',
    'LANG_PRICING_DAILY_TEXT' => 'Daily',
    'LANG_PRICING_HOURLY_TEXT' => 'Hourly',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Per Reservation',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'Combined - Daily &amp; Hourly',
    'LANG_PRICING_PER_ORDER_TEXT' => 'reservation',
    ...
    'LANG_PRICING_PER_DAY_TEXT' => 'day',
    'LANG_PRICING_PER_DAY_SHORT_TEXT' => 'd.',
    'LANG_PRICING_PER_NIGHT_TEXT' => 'night',
    'LANG_PRICING_PER_NIGHT_SHORT_TEXT' => 'n.',
    'LANG_PRICING_PER_HOUR_TEXT' => 'hour',
    'LANG_PRICING_PER_HOUR_SHORT_TEXT' => 'hr',
    'LANG_PRICING_PER_MINUTE_TEXT' => 'minute',
    'LANG_PRICING_PER_MINUTE_SHORT_TEXT' => 'min',

    // Search step no. 1 - item search
    'LANG_ORDER_TEXT' => 'Reservation',
    'LANG_PICKUP_TEXT' => 'Pick-Up',
    'LANG_RETURN_TEXT' => 'Return',
    'LANG_INFORMATION_TEXT' => 'Information',
    'LANG_CITY_AND_LOCATION_TEXT' => 'City &amp; Location:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Pick-Up City &amp; Location:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Pick-Up City &amp; Location -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Return City &amp; Location:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Return City &amp; Location -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Reservation Period:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'I have a reservation code:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- I have a reservation code -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Pick-up Location',
    'LANG_LOCATION_RETURN_TEXT' => 'Return Location',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- All Types ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- All Transmissions ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Select Pick-up Location --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Select Return Location --',
    ...
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Show car description',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Update My Reservation',
    'LANG_CANCEL_ORDER_TEXT' => 'Cancel Reservation',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Change Date, Time &amp; Location',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Change Cars',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Change Cars',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Change Extras',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Change Rental Options',
    'LANG_IN_THIS_LOCATION_TEXT' => 'In this location',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Not Allowed',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Not Allowed',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Reservation details',
    'LANG_ORDER_CODE_TEXT' => 'Reservation Code',
    'LANG_ORDER_CODE2_TEXT' => 'Reservation code', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'edit',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Pick-up',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Business hours',
    'LANG_ORDER_FEE_TEXT' => 'Fee',
    'LANG_ORDER_RETURN_TEXT' => 'Return',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'after hours',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'after hours',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'After hours pickup',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Impossible',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'After hours return',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Impossible',
    'LANG_SEARCH_RESULTS_TEXT' => 'Search Results',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Choose Rental Options',
    'LANG_SELECTED_ITEMS_TEXT' => 'Selected Cars',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'No car extras available. Click on continue button',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Pick-up Date &amp; Time',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Return Date &amp; Time',
    'LANG_UNIT_PRICE_TEXT' => 'Unit price',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Pick-up Fee',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Pick-up fee', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Return Fee',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Return fee', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Nightly rate applied)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'vehicle(s)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'extra(s)',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Pay Now / at Pick-up',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Pay Now',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Pay at Pick-up',
    'LANG_PAYMENT_PAY_LATER_OR_ON_RETURN_TEXT' => 'Pay Later / on Return',
    'LANG_PAYMENT_PAY_LATER_TEXT' => 'Pay Later',
    'LANG_PAYMENT_PAY_ON_RETURN_TEXT' => 'Pay on Return',
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Rental Details',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'Sub Total',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Grand Total',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Customer Details',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Search for Existing Customer Details',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Existing Customer',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Fetch Details',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'Or enter customer details',
    'LANG_CUSTOMER_TEXT' => 'Customer',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'City',
    'LANG_STATE_TEXT' => 'State',
    'LANG_COUNTRY_TEXT' => 'Country',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Additional Comments',
    'LANG_CUSTOMER_ID_TEXT' => 'Customer ID',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'Pay by',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'I agree with the terms &amp; conditions',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'Terms &amp; Conditions',
    'LANG_FIELD_REQUIRED_TEXT' => 'This field is required',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Payment Details',
    'LANG_PAYMENT_OPTION_TEXT' => 'Pay By',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'Processing Payment...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Please wait, your order will be processed...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'Pay Online',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Pay at Pick-up',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Your reservation received. Reservation code %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Your reservation confirmed. Reservation code %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Your reservation updated. Reservation code %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Invoice sent to your email address',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Reservation Failure',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Search All Cars',
    ...
    'LANG_DAY_PRICE_TEXT' => 'Day price',
    'LANG_HOUR_PRICE_TEXT' => 'Hour price',
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'There is no cars in this category',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Price for a day starting from',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Price for a hour starting from',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'with applied',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'discount',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Day',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Cars Availability For',
    'LANG_ITEMS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Cars Availability in Next 30 Days',
    'LANG_ITEMS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Partial Cars Availability For',
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Cars Availability This Month', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Cars Availability Next Month', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Total cars:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Extras Availability For',
    'LANG_EXTRAS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Extras Availability in Next 30 Days',
    'LANG_EXTRAS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Partial Extras Availability For',
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Extras Availability This Month', // Not used
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Extras Availability Next Month', // Not used
    'LANG_EXTRA_ID_TEXT' => 'ID',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Total extras:',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'Fuel Type',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'Fuel',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Gearbox Type',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'Gearbox',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'Fuel Consumption',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'Fuel usage',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Passenger seats (incl. driver)',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Max passengers',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'Engine capacity',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'Engine capacity',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Maximum Luggage',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Max luggage',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Doors',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Doors',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Daily Mileage Limit',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Mileage',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Price from',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'Features',
    'LANG_PRICING_GET_IT_TEXT' => 'Rent',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Location Fees',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Minimal driver age',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Minimal driver age',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Additional information',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Show car model description',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'Reservation %s cancelled successfully.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'Reservation was not cancelled. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Change
reservation',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Change reservation',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Please enter reservation number!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'Required field',
    'LANG_ERROR_IS_EMPTY_TEXT' => 'is empty',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'No customer exists with provided details. Please create a new account.',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'No errors',
    ...
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'does not exist',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'Please select at least one car',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'Please select at least one car',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'Online reservation system is currently disabled. Please try again later.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'Your return date must be later than pickup date. Please choose valid pickup and return dates.',
    ...
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'Pick-up is not possible on',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'Please modify your pickup date &amp; time according to rental location current date &amp; time.',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'Rental location current date &amp; time is',
    'LANG_ERROR_EARLIEST_POSSIBLE_PICKUP_DATE_TIME_TEXT' => 'Earliest possible pickup date date &amp; time is',
    'LANG_ERROR_OR_NEXT_BUSINESS_HOURS_OF_PICKUP_LOCATION_TEXT' => 'or the first time after it, when selected pickup location is open',
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'Pick-Up Date &amp; Time Cannot be less than from Return Date & Time. Please select correct Pick-Up & Return Date & Time',
    ...
    'LANG_ERROR_LOCATION_OPEN_HOURS_ARE_TEXT' => 'This location open hours on %s, %s are %s.',
    'LANG_ERROR_LOCATION_WEEKLY_OPEN_HOURS_ARE_TEXT' => 'This location open hours during the week are:',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'After hours pickup location open hours are %s.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'After hours return location open hours are %s.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'After hours pickup is not allowed at this location.',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'After hours return is not allowed at this location.',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => 'Maximum reservation length can not be longer than %s.',
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Invalid reservation code or this reservation do not exist anymore.',
    'LANG_ERROR_INVALID_SECURITY_CODE_TEXT' => 'Security code is not valid.',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Reservation No. %s already marked as departed, and is not available for further editing.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Reservation No. %s has been cancelled.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Reservation No. %s was already refunded and is not available anymore.',
    'LANG_ERROR_PAYMENT_METHOD_IS_NOT_YET_IMPLEMENTED_TEXT' => 'Error: You\'re tried to pay with a payment method, that is not yet available for use in the system.',
    'LANG_ORDER_OTHER_ERROR_TEXT' => 'Other reservation error. If you keep seeing this message, please contact website administrator.',

    // Assistant Element
    'LANG_ASSISTANT_TEXT' => 'Assistant',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_DESCRIPTION_TEXT' => 'Secure Instant Payment',
    'LANG_PAYMENT_METHOD_DEFAULT_STRIPE_TEXT' => 'Credit Card (via Stripe.com)',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Bank Transfer',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'Your Bank Details',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'Pay over the Phone',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Pay at Pick-up',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Credit Card Required',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Dear',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Regards',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_DETAILS_TEXT' => 'Reservation details - no. [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CONFIRMED_TEXT' => 'Reservation no. [RESERVATION_CODE] - confirmed',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CANCELLED_TEXT' => 'Reservation no. [RESERVATION_CODE] - cancelled',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_DETAILS_TEXT' => 'Notification: new reservation - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CONFIRMED_TEXT' => 'Notification: reservation paid - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CANCELLED_TEXT' => 'Notification: reservation cancelled - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_RECEIVED_TEXT' => 'Your reservation details were received.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_DETAILS_TEXT' => 'Your reservation details:',
    'LANG_EMAIL_DEFAULT_BODY_PAYMENT_RECEIVED_TEXT' => 'We received your payment. Your reservation is now confirmed.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_CANCELLED_TEXT' => 'Your reservation no. [RESERVATION_CODE] were cancelled.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_RECEIVED_TEXT' => 'New reservation no. [RESERVATION_CODE] received from [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_DETAILS_TEXT' => 'Reservation details:',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_PAID_TEXT' => 'Reservation no. [RESERVATION_CODE] was recently paid by [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_CANCELLED_TEXT' => 'Reservation no. [RESERVATION_CODE] for [CUSTOMER_NAME] was recently cancelled.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_CANCELLED_ORDER_DETAILS_TEXT' => 'Details of reservation, which were cancelled:',
    ...
    'LANG_PAGE_POST_LABEL_SINGULAR_NAME_TEXT' => 'Car Rental Pages', // singular_name
    'LANG_PAGE_POST_LABEL_MENU_NAME_TEXT' => 'Car Rental Pages', // menu_name
    'LANG_PAGE_POST_LABEL_PARENT_PAGE_COLON_TEXT' => 'Parent Rental Page', // parent_item_colon
    'LANG_PAGE_POST_LABEL_ALL_PAGES_TEXT' => 'All Rental Pages', // all_items
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'No car models available. Please change reservation period or modify your search criteria.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_PAGE_URL_SLUG_TEXT' => 'car-rental', // Latin letters only
    'LANG_SETTINGS_DEFAULT_ITEM_MODEL_URL_SLUG_TEXT' => 'car-model', // Latin letters only
    'LANG_SETTINGS_DEFAULT_LOCATION_URL_SLUG_TEXT' => 'car-location', // Latin letters only
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_TITLE_TEXT' => 'Payment cancelled',
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_CONTENT_TEXT' => 'Payment was cancelled. Your reservation were not confirmed.',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_TITLE_TEXT' => 'Reservation confirmed',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_CONTENT_TEXT' => 'Thank you. We received your payment. Your reservation is now confirmed.',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Terms of Use for Renting a Car',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_CONTENT_TEXT' => 'You must follow the guidelines &amp; terms for the regular car rental.',
    ...
    'LANG_TRANSACTION_ID_TEXT' => 'Transaction ID',
    'LANG_TRANSACTION_ID_EXTERNAL_ID_AND_LEGAL_COUNTRY_TEXT' => 'Transaction Id, External Id & Legal Country',
    'LANG_TRANSACTION_EXTERNAL_ID_TEXT' => 'External Transaction ID',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'Payer E-mail',
    ...
    //New strings
    'LANG_FLEET_MODEL_PRICES_OVERVIEW' => 'Car Prices for Today',
    'LANG_FLEET_MODEL_PRICES_DISCOUNTS_IN_ADVANCE' => 'Car Discount Plans for Reservation in Advance',
    'LANG_SINGLE_VEHICLE_TITLE' => 'car',
    'LANG_MULTIPLE_VEHICLE_TITLE' => 'cars',
    'LANG_SINGLE_VEHICLE_TITLE_UPPERCASE' => 'Car',
    'LANG_MULTIPLE_VEHICLE_TITLE_UPPERCASE' => 'Cars',
    'LANG_SINGLE_VEHICLE_TITLE_FULL_UPPERCASE' => 'CAR',
    'LANG_INSTRUCTIONS_PARAGRAPH1' => 'Please note, that if you see that after update or after uploading the first car image the &quot;/wp-content/uploads/CarRentalGallery/&quot; directory is not created (or &quot;/wp-content/uploads/sites/2/CarRentalGallery/&quot; etc. for multisite setup), you will have to create that directory manually via FTP client like FileZilla and set it&#39;s permission to 0777.',
);